...
import { traduciConditie } from '../constants/index';
            ...
            <SafeAreaView className="flex flex-1">
              ...
              <View className="mx-4 flex justify-around flex-1 mb-2">
                ...
                <View className="space-y-2">
                  ...
                  <Text className="text-center text-white text-xl tracking-widest">
                    {traduciConditie(current?.condition?.text)}
                  </Text>
                </View>

                {/* Viteza vântului, umiditatea şi răsăritul */}
              ...
              <View className="mb-2 space-y-3">
                <View className="flex-row items-center mx-5 space-x-2">
                  ...
                  <Text className="text-white text-base">Prognoza zilnică</Text>
                </View>
                <ScrollView   
                  horizontal
                ...
                >
                  {
                    weather?.forecast?.forecastday?.map((item, index) => {
                      ...
                      let dayName = date.toLocaleDateString('ro-RO', options);
